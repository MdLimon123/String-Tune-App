              ...
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: _buildCounter(
                        value: '${wb.formatScale(calc.scaleLength)}"',
                        onDecrement: calc.decrementScaleLength,
                        onIncrement: calc.incrementScaleLength,
                      ),
                    ),
                    ...
                    ...List.generate(calc.stringCount, (i) {
                      ...
                      return _buildStringRow(
                        ...
                        scale: scale,
                        onScaleUp: () => calc.incrementPerStringScale(i),
                        onScaleDown: () => calc.decrementPerStringScale(i),
