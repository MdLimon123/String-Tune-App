...
class _ArtistTuningsDetailsPageState extends State<ArtistTuningsDetailsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppbar(title: "Matt Pike"),
            ...
            child: Row(
              ...
              children: [
                _typeBtn(
                  'P',
                  s['type'] == 'P',
                  () => setState(() => guitarStrings[index]['type'] = 'P'),
                ),
                const SizedBox(width: 6),
                _typeBtn(
                  'W',
                  s['type'] == 'W',
                  () => setState(() => guitarStrings[index]['type'] = 'W'),
                ),
              ],
            ),
          ),
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  GestureDetector(
                    onTap: () => setState(
                      () => guitarStrings[index]['scale'] =
                          (guitarStrings[index]['scale'] as double) + 0.5,
                    ),
                    child: const Icon(
                  ...
                  GestureDetector(
                    onTap: () => setState(() {
                      double cur = guitarStrings[index]['scale'] as double;
                      if (cur > 24.0) guitarStrings[index]['scale'] = cur - 0.5;
                    }),
                    child: const Icon(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                GestureDetector(
                  onTap: () => setState(
                    () => guitarStrings[index]['gauge'] =
                        (guitarStrings[index]['gauge'] as int) + 1,
                  ),
                  child: const Icon(
                    Icons.keyboard_arrow_up,
                    color: Colors.white,
                ...
                GestureDetector(
                  onTap: () => setState(() {
                    int g = guitarStrings[index]['gauge'] as int;
                    if (g > 1) guitarStrings[index]['gauge'] = g - 1;
                  }),
                  child: const Icon(
                    Icons.keyboard_arrow_down,
                    color: Colors.white,
