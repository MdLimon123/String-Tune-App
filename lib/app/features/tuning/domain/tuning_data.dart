...
const List<TuningDefinition> tuningList = [
  TuningDefinition(
    ...
    group: 'Standard',
    names6: ['e', 'B', 'G', 'D', 'A', 'E'],
    notes: [329.63, 246.94, 196.00, 146.83, 110.00, 82.41],
  ),
  TuningDefinition(
    id: 'Eb',
    label: 'Eb Standard',
  ...
  TuningDefinition(
    ...
    notes: [261.63, 196.00, 155.56, 116.54, 87.31, 65.41],
  ),
  TuningDefinition(
    id: 'B',
    label: 'B Standard',
    group: 'Standard',
    names6: ['b', 'F#', 'D', 'A', 'E', 'B'],
    notes: [246.94, 185.00, 146.83, 110.00, 82.41, 61.74],
  ),
  TuningDefinition(
    id: 'Bb',
    label: 'Bb Standard',
    ...
    notes: [233.08, 174.61, 138.59, 103.83, 77.78, 58.27],
  ),
  TuningDefinition(
    id: 'A',
    label: 'A Standard',
